            ...
            <ul className="flex items-center gap-3 sm:gap-5">
                {toolsData.map((tool,idx)=>{
                    return (
                      <li
                        key={idx}
                        className="flex items-center justify-center w-12 sm:w-14 aspect-square border border-gray-400 rounded-lg cursor-pointer hover:bg-light-hover hover:-translate-y-1 duration-500 hover:shadow-black"
                      >
